...
const RULES: Partial<Record<string, RuleDef>> = {
  ...
  mahjong:    { icon: "mahjong",   lines: ["Choisissez un thème (Nature, Vacances, Travail, Animaux).", "Retirez les tuiles par paires identiques.", "Bordure rouge = piège, bordure dorée = bonus !", "Videz tout le plateau pour gagner !"] },
